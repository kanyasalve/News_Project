            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  <!-- <h2 class="page-heading">Author Name</h2> -->
                   <?php
                    $auth_id = mysqli_real_escape_string($conn, $_GET['aid']);
             ...
             $row1 = mysqli_fetch_assoc($result1);
                ?>
                 ...
                 $sql = "SELECT post.post_id, post.title, post.description, 
                        post.post_date, category.category_name, user.username, 
                        post.category, post.post_img, post.author 
                        FROM post 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    <h3><a href='single.php?post_id=<?php echo $row['post_id']; ?>'><?php echo $row['title']; ?></a>
                                    </h3>
